...
<head>
  ...
  <script src="resources/js/flightCancel.js"></script>
     <link href="resources/css/flightCancel.css" rel="stylesheet">
...
<body id="page-top" class="index">
    ...
    <!-- Navigation -->
    <nav id="mainNav" class="navbar navbar-default navbar-custom navbar-fixed-top bg-darkest-gray">
        <div class="container">
    ...
    <h3 class="section-heading" >Predict the flight status for your trip!</h3>
    <br/>
    ...
    <div id ="displayDiv" class="panel panel-warning">
    	...
    	<div class="progress">
    	  ...
    	  <div class="panel-heading noPadding text-center">Estimate Flight Cancellation Summary</div>
		   		...
		   		<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
			        ...
			        <thead id="resultHead">
			            <tr>
			                ...
			                <th>Estimated Flight Status</th>
			                <th>Estimated Status Probability</th>
			            </tr>
			        </thead>
